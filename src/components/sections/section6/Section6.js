            ...
            <Flex my='96px' justifyContent="center" fontFamily="'Montserrat', sans-serif !important">
                <Center flexDirection="column" gridGap="40px" textAlign="center">
                    ...
                    <Text lineHeight="30px" px="20px">
                        The best combos for your parties. If you purchase any of the 3 combos <br />
                        in the next few minutes you will get a 25% discount.
                    </Text>
                    <Flex flexDirection={['column', 'column', 'column', 'row', 'row']} gridGap="40px" textAlign="center" >
                        {
                            data.map(e => <CardCombos key={e.id} data={e} />)
                        }
                    </Flex>
                </Center>
            </Flex>
