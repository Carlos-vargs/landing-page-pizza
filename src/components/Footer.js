        ...
        <Fragment>
            ...
            >
                <Center flexDirection="column">
                    <Logo wSize={['160px', '160px', '160px', '200px', '200px']} hSize={'auto'} />
                    <Text as="h6" mt="16px" fontSize="12px">{motto}</Text>
                    <ContainerSocialNetworks data={socialNetworks} mtSize={'40px'} gap={'14px'} />
